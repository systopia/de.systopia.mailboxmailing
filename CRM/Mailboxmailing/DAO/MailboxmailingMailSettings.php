 ...
 * (GenCodeChecksum:8b27e1088c9900a31ea85ef6db6f0811)
 */
...
class CRM_Mailboxmailing_DAO_MailboxmailingMailSettings extends CRM_Core_DAO {
  ...
  /**
   * Implicit FK to civicrm_option_value.value for from email address to use when sending notifications.
   *
   * @var string
   */
  ...
  /**
   * The subject to use for notifications sent to disallowed senders.
   *
   * @var string
   */
  public $notify_disallowed_sender_subject;
  ...
  /**
   * The subject to use for notifications about errors sent to senders.
   *
   * @var string
   */
  public $notify_sender_errors_subject;
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'from_email_address_id' => [
          ...
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Mailboxmailing_ExtensionUtil::ts('From e-mail address'),
          'description' => CRM_Mailboxmailing_ExtensionUtil::ts('Implicit FK to civicrm_option_value.value for from email address to use when sending notifications.'),
          'maxlength' => 512,
          'size' => CRM_Utils_Type::HUGE,
          'table_name' => 'civicrm_mailboxmailing_mail_settings',
          'entity' => 'MailboxmailingMailSettings',
          ...
          'pseudoconstant' => [
            'optionGroupName' => 'from_email_addresses',
            'optionEditPath' => 'civicrm/admin/options/from_email_addresses',
          ]
        ],
        ...
        'notify_disallowed_sender_subject' => [
          'name' => 'notify_disallowed_sender_subject',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Mailboxmailing_ExtensionUtil::ts('Disallowed sender notification subject'),
          'description' => CRM_Mailboxmailing_ExtensionUtil::ts('The subject to use for notifications sent to disallowed senders.'),
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
          'table_name' => 'civicrm_mailboxmailing_mail_settings',
          'entity' => 'MailboxmailingMailSettings',
        ...
        'notify_sender_errors_subject' => [
          'name' => 'notify_sender_errors_subject',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Mailboxmailing_ExtensionUtil::ts('Error notification subject'),
          'description' => CRM_Mailboxmailing_ExtensionUtil::ts('The subject to use for notifications about errors sent to senders.'),
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
          'table_name' => 'civicrm_mailboxmailing_mail_settings',
          'entity' => 'MailboxmailingMailSettings',
